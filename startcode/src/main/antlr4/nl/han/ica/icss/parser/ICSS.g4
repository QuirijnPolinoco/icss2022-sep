...
declaration: propertyName COLON additiveExpression SEMICOLON;
...
variableAssignment: variableReference ASSIGNMENT_OPERATOR additiveExpression SEMICOLON;
variableReference: CAPITAL_IDENT;

// if [ additiveExpression ] { ... } [ else { ... } ]

ifClause: IF BOX_BRACKET_OPEN additiveExpression BOX_BRACKET_CLOSE OPEN_BRACE ruleBody CLOSE_BRACE elseClause?;
